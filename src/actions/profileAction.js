...
export const getProfileOneDetails = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`http://localhost:3001/api/admins/profiles/6352959893d3aa6ffe45727f`, config);
        dispatch({
...
export const updateProfile = (profile) => async (dispatch, getState) => {
    try{
        ...
        const { data } = await axios.put(`http://localhost:3001/api/admins/profiles/6352959893d3aa6ffe45727f`, profile, config);
        dispatch({ 
...
export const createProfileTech = 
    ( techData) => async(dispatch,getState) => {
        try{
            ...
            const { data } = await axios.post(`http://localhost:3001/api/admins/profiles/6352959893d3aa6ffe45727f/technologies`, techData, config);
            dispatch({
