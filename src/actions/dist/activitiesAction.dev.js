...
var req = "http://localhost:3001/api/admins/activities";
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 6;
            return regeneratorRuntime.awrap(_axios["default"].post("".concat(req), activitiesData, config));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 6;
            return regeneratorRuntime.awrap(_axios["default"].put("".concat(req, "/").concat(id), activitiesData, config));
