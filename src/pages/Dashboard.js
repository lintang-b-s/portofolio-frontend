...
const SidebarProfile = () => {
    ...
    const {
        ...
        error: errorUpdate,
        success:successUpdate } = profileUpdate
...
// salah di logic useeffectnya
    useEffect(() => {
        ...
        else if (profile._id != "6517b8092b9496c8f240218e"){
    ...
    function createTechHandler (e) {
        ...
        techData.append("images", techImg);
    ...
    const submitHandler = (e) => {
        ...
        profData.set("name", name);
        profData.set("description", description);
        profData.set("birthDate", birthDate);
        profData.set("education", education);
        profData.set("organizations", affiliation);
                            ...
                            <div className="w-full lg:w-6/12 px-4">
                                ...
                                <div className="w-full lg:w-6/12 px-4">
                                    <div className="relative z-0 mb-6 w-full group" controlId="affiliation">
                                        ...
                                        <label htmlFor="affiliation" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Add Organization</label>
                                ...
                                <div className="w-full lg:w-6/12 px-4">
                                        ...
                                        <label htmlFor="activities" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Add Activities</label>
                                ...
                                <div className="w-full lg:w-6/12 px-4">
                                        <div className="relative z-0 mb-6 w-full group" controlId="projects">
                                            ...
                                            <label htmlFor="projects" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Add projects</label>
                                ...
                                <div className="w-full lg:w-6/12 px-4">
                                        <div className="relative z-0 mb-6 w-full group" controlId="imgUpload">
