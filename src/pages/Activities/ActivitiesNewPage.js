                ...
                <div class={`non-sidebar basis-0  grow  px-7 md:px-10 mx-auto w-full  `}>
                        ...
                        <form onSubmit={submitHandler} >
                            ...
                            <div className="relative z-0 mb-6 w-full group"   controlId="description">
                                ...
                                <label htmlFor="description" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Activity description</label>
                            ...
                            <div className="relative z-0 mb-6 w-full group" controlId="affiliation">
                                ...
                                <select id="affiliation"  name="affiliation" onChange={(e) => setAffiliationName(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
