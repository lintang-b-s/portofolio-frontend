...
const ProjectListAdmin = () => {
    ...
    //conditional rendering project.affiliation
    // const aff = () =>{
    //     if (project.affiliation)  {
    //         return <td className="py-4 px-6 text-right">
    //                 {project.affiliation.name} </td>
        ...
        <div className="flex flex-wrap gap-x-3 mx-3 my-5 text-center bg-white rounded-lg border shadow-md sm:p-2 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="basis-0  grow  w-full   overflow-x-auto relative shadow-md shadow-md sm:rounded-lg">
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                    {projects.sort((a, b) => b.createdAt.localeCompare(a.createdAt)).map((project) => (
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <th scope="row" key={project._id} className="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {project.name}
                            </th>
                            ...
                            <td className="py-4 px-6">
                                ...
                                dateStyle: "medium",
                                timeStyle: "short",
                                }).format(new Date(project.date1.toString()))}
                            </td>
...
{/*                             
                            ...
                            <td className="py-4 px-6" >{project.profile.name} </td>
                            
                                {/* {project.profile.map((profile, index) => 
                                    <td className="py-4 px-6" key={index}>{profile.name} </td>
                                        )} */}
