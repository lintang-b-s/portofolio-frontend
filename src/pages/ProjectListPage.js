...
const ProjectListAdmin = () => {
    ...
    //         return <td class="py-4 px-6 text-right">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    {projects.sort((a, b) => b.createdAt.localeCompare(a.createdAt)).map((project) => (
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <th scope="row" key={project._id} class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {project.name}
                            </th>
                            <td class="py-4 px-6">
                                {project.description}
                            ...
                            <td class="py-4 px-6" >{project.profile.name} </td>
