...
const ProjectEditPage = () => {
    ...
    //mungkin bisa tambahkan project reducer -> state.project
    //ambil state profileonedetails
...
//buat list affiliation
  ...
  useEffect(() => {
    if (successUpdate) {
      ...
      // setAffiliation(organizations[0]);
      setProfileName(project.profile);
  ...
  const submitHandler =  (e) => {
    ...
    formData.set("affiliation", affiliation._id);
    formData.set("profile", profileName._id )
        ...
        <div class={`non-sidebar basis-0  grow  px-7 md:px-10 mx-auto w-full  `}>
          ...
          <form onSubmit={submitHandler} enctype="multipart/form-data">
              <div className="relative z-0 mb-6 w-full group" controlId="name">
                ...
                <input type="text" name="projectName"   value={name}  onChange={(e) => setName(e.target.value)} id="projectName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
              ...
              <div className="relative z-0 mb-6 w-full group"   controlId="description">
                ...
                <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Project description</label>
              ...
              <div className="relative z-0 mb-6 w-full group" controlId="customFile">
                  {/* <input accept="image/*" multiple onChange={handleChange('photo')} className="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="icon-button-file" type="file" />
                <label htmlFor="icon-button-file" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"> </label> */}
                {/* untuk upoload image */}
              ...
              <div className="relative z-0 mb-6 w-full group" controlId="technologies">
                ...
                <input type="text" name="technologies"  value={technologies}  onChange={(e) => setTechnologies(e.target.value)} id="technologies" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
                <label for="technologies" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Teknologi yang dipakai</label>
...
{/* onChange={(e) => setAffiliation (e.target.value)} */}
                <label for="affiliation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Affiliation</label>
                  <select id="affiliation" name="affiliation" onChange={(e) => setAffiliation (e.target.value)} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    {/* <option value={affiliation._id}>{organization.name}</option> */}
              ...
              <div className="relative z-0 mb-6 w-full group" controlId="profile">
                ...
                <select id="profile" name="profile" onChange={(e) => setProfileName (e.target.value)}  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                  <option name="profile"  value={profile._id}>{profile.name}</option>
