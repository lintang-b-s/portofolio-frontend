...
const OrganizationEditPage = () => {
    ...
    useEffect(() => {
        ...
        if (successUpdate) {
            ...
            setActivities(organization.activities);
            setProjectsName(organization.projects);
            setProfileName(organization.profile);
    ...
    const submitHandler = (e) => {
        ...
        formData.set("activities", activities._id);
        formData.set("projects", projectsName._id);
        ...
        console.log("activities", activities._id);
        console.log("projects", projectsName._id);
        console.log("date2", date2);
        console.log("profile", profileName._id);
        ...
        <div class={`non-sidebar basis-0  grow  px-7 md:px-10 mx-auto w-full  `}>
          ...
          <form onSubmit={submitHandler} enctype="multipart/form-data">
              ...
              <label for="activities" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Activities</label>
                  <select id="activities" name="activities" onChange={(e) => setActivities (e.target.value)} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
