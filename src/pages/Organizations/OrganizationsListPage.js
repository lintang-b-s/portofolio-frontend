                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    {organizations.sort((a, b) => b.createdAt.localeCompare(a.createdAt)).map((organization) => (
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <th scope="row" key={organization._id} className="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {organization.name}
                            </th>
                            ...
                            <td className="py-4 px-6">
                                {organization.activities && organization.activities.map((actv) => <span>{actv.name},</span>)}
                            </td>
                            <td className="py-4 px-6 text-right">
                                {organization.projects &&  organization.projects.map((prj) => <span>{prj.name},</span>)}
                            </td>
                            <td className="py-4 px-6">
                                {organization.profile.name && organization.profile.name}
                            </td>
